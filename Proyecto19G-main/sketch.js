...
//FUNCION PARA CARGAR IMÁGENES Y ANIMACIONES
  function preload() {
    vistaderecha = loadImage("Carpeta1/puca.png");

    //GUARDAR IMAGEN FONDO
    fondoImg = loadImage("Carpeta1/backgroundpuca.jpeg");
    premiosImg = loadImage("Carpeta1/trofeo.png");
    enemigosImg = loadImage("Carpeta1/tobe.png");
    baseImg = loadImage("Carpeta1/plataformapuca.png");
